...
\begin{definition}[Gibbs Measures]
    ...
    \begin{align*}
        ...
        \gamma&\mapsto\left\{\mu\in\mathfrak{M}(E^S, \mathcal{E}^S)~\middle\vert~\mu(A\mid\mathcal{F}_{S\setminus\Lambda})=\gamma_\Lambda(A\mid\cdot)~\mu\text{-a.s. for each } A\in\mathcal{E}^S\text{ and }\Lambda\in\text{Finset}(S)\right\}
    \end{align*}
