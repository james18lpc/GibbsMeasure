...
\begin{definition}[Conditional Expectation Kernel]
    ...
    \uses{def:kernel}
    \lean{ProbabilityTheory.condexpKernel}
    \leanok
...
\begin{lemma}[Defining Characteristic of Conditional Expectation Kernels]
    \label{lemma:def-char-cond-exp-ker}
...
\begin{lemma}[Characterization of Proper Conditional Expectation Kernels]
    \label{lemma:cond-exp-ker-proper-char}
    \uses{def:cond-exp-ker, def:proper-kernel}
    \lean{ProbabilityTheory.Kernel.IsProper, ProbabilityTheory.condexpKernel}
    \leanok
