...
% Remark 1.28.5
\begin{lemma}[Every specification is a modifier of the counting measure]
...
% Proposition 1.30
\begin{proposition}[Characterisation of modifiers]
...
\begin{definition}[Premodifier]
    ...
    A family of functions $h_\Lambda : (S \to E) \to [0, \infty[$ is a {\bf premodifier} if
...
% Remark 1.32
\begin{lemma}[Premodifiers give rise to modifiers]
