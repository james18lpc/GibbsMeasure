...
\begin{lemma}[Every specification is a modification of some ISSSB, Remark 1.28.5]
...
\begin{proposition}[Characterisation of modifiers, Proposition 1.30]
    \label{prop:modif-tfae}
    \uses{def:modif}
    \lean{Specification.isModifier_iff_ae_eq, Specification.isModifier_iff_ae_comm}
    \leanok
    ...
    \begin{enumerate}
        ...
        $$\rho_{\Lambda_2}(\zeta_1)\rho_{\Lambda_1}(\zeta_1) = \rho_{\Lambda_2}(\zeta_1) \rho_{\Lambda_1}(\zeta_2)$$
